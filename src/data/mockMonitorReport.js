...
export const mockGeneratedReports = [
    {
        ...
        status: 'Finalized',
        appliedFilters: { quarter: 'Q3', year: '2026', scope: 'PRJ-2026-001', activityType: 'All Types', options: 'Evaluation, Beneficiaries, Docs' },
    ...
    },
    {
        ...
        appliedFilters: { quarter: 'Q4', year: '2026', scope: 'PRJ-2026-002', activityType: 'Training', options: 'Beneficiaries, Docs' },
